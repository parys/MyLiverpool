    ...
    var customEmoticons = (function () {
        ...
        var getEmojis = function () {
            ...
            for (var i = 0; i < emoArray.length; i++) {
                for (var j = 0; j < emoArray[i].length; j++) {
                    matches.push({
                        text: emoArray[i][j],
                        value: emoArray[i][j],
                        icon: emoArray[i][j]
      ...
      function getHtml() {
        ...
        emoticonsHtml = '<table role="list" class="mce-grid">';
          ...
          emoArray.forEach(function (row) {
          emoticonsHtml += '<tr>';
              row.forEach(function (icon) {
                  var emoticonUrl = '/smiles/' + icon + '.gif';
        ...
        var register$1 = function (editor) {
            editor.ui.registry.addButton('customEmoticons1', {
                icon: '-rule',
