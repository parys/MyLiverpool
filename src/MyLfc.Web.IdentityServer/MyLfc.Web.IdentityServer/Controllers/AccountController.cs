...
using MyLfc.Domain;
using MyLfc.Web.IdentityServer.Models;

namespace MyLfc.Web.IdentityServer.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(SignInManager<User> signInManager, UserManager<User> userManager, IIdentityServerInteractionService interaction, IAuthenticationSchemeProvider schemeProvider, IClientStore clientStore, IEventService events)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (button != "login")
            {
                if (context != null)
                {
                    ...
                    // todo if (await _clientStore.IsPkceClientAsync(context.ClientId))
                  //  {
